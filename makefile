...
game:
	@g++ -std=c++20 main.cpp Game.cpp Entity.cpp Player.cpp Enemy.cpp NPC.cpp Tile.cpp Level.cpp Button.cpp Weapon.cpp Bow.cpp BasicBow.cpp MultiBow.cpp CrossBow.cpp Melee.cpp BroardSword.cpp Daggers.cpp ShortSword.cpp GameUI.cpp NumDisplay.cpp Counter.cpp List.cpp -o Jumperboiii -lsfml-graphics -lsfml-window -lsfml-system
